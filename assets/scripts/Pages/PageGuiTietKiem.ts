...
export class PageGuiTietKiem extends Page {
    actions: any
    props: any
    ...
    onLoad() {
        this.btnConfirm.on(cc.Node.EventType.TOUCH_END, () => {
            ...
            window.location.href = this.props.deeplinks.data[DeeplinkTypesToName[EDeeplinkTypes.THAM_QUAN_GUI_TIET_KIEM]];
...
export default connect(mapStateToProps, mapDispatchToAction)(PageGuiTietKiem)